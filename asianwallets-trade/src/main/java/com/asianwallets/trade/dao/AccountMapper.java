...
public interface AccountMapper extends  BaseMapper<Account> {
     ...
     * @return
     */
    @Select("select id,settle_balance as settleBalance,freeze_balance as freezeBalance,clear_balance as clearBalance from account  where merchant_id = #{merchantId} and currency = #{currency} and enabled=true")
