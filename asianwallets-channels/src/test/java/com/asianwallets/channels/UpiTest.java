...
public class UpiTest extends SpringBootServletInitializer {
    ...
    //冲正
    @Test
    public void upiCZTest()  throws Exception {
        String domain11 = String.valueOf(System.currentTimeMillis()).substring(0, 6);
    ...
    //预授权
    @Test
    public void upiYSQTest()  throws Exception {
        ISO8583DTO iso8583DTO = new ISO8583DTO();
    ...
    //预授权冲正
    @Test
    public void upiYSQCZTest()  throws Exception {
    ...
    //预授权撤销
    @Test
    public void upiYSQCXTest()  throws Exception {
        ISO8583DTO iso8583DTO = new ISO8583DTO();
        iso8583DTO.setMessageType("0100");
        iso8583DTO.setProcessingCode_3("200000");
        iso8583DTO.setAmountOfTransactions_4("000000000100");
    ...
    //预授权完成
    @Test
    public void upiYSQWCTest()  throws Exception {
        ISO8583DTO iso8583DTO = new ISO8583DTO();
        iso8583DTO.setMessageType("0200");
        ...
        //自定义域
        iso8583DTO.setReservedPrivate_60("22000001000600");//01000001000000000
        iso8583DTO.setOriginalMessage_61("0000015544560619");
    ...
    //预授权完成撤销
    @Test
    public void upiYSQWCCXTest()  throws Exception {
        ISO8583DTO iso8583DTO = new ISO8583DTO();
        iso8583DTO.setMessageType("0200");
        iso8583DTO.setProcessingCode_3("200000");
        iso8583DTO.setAmountOfTransactions_4("000000000100");
