...
public class DateToolUtils extends DateUtils {
     ...
     * @return
     */
    public static Date getReqDateG(String date) {
        try {
...
// out += temp.substring(12,14) + temp.substring(15,17);
    ...
    public static long getDateDiff(Date date1, Date date2) {
        if (ValidatorToolUtils.isNullOrEmpty(date1) || ValidatorToolUtils.isNullOrEmpty(date1)) {
            return 0L;
        }
...
// subYear==0,说明是同一年
     ...
     * @return
     */
    public static Date getTodayWeeHours() {
     ...
     * @return
     */
    public static Date getPreHourTime(int temp) {
