...
@Data
@Entity
@Table(name = "rights_grant")
@ApiModel(value = "权益发放管理表", description = "权益发放管理表")
public class RightsGrant extends BaseEntity {
    ...
    private Integer cancelVerificationAmount=0;
    ...
    @ApiModelProperty(value = "核销成功更新核销数量")
    @Column(name = "ext1")
    private String ext1;

    @ApiModelProperty(value = "退款成功更新剩余数量")
    @Column(name = "ext2")
    private String ext2;

    @ApiModelProperty(value = "发券更新")
    @Column(name = "ext3")
    private String ext3;
