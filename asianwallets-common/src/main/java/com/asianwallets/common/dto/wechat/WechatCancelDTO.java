...
public class WechatCancelDTO {
    ...
    public WechatCancelDTO() {
    }

    public WechatCancelDTO(OrderRefund orderRefund, Channel channel) {
    ...
    public WechatCancelDTO(Orders orders, Channel channel) {
        this.apikey = channel.getMd5KeyStr();
        this.appid = "wx14e049b9320bccca";
        //this.sub_appid = "";
        this.sign_type = "MD5";
