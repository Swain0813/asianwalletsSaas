...
public class Demo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ISO8583DTO iso8583DTO1281 = ISO8583Util.unpackISO8583DTO("");
        System.out.println(iso8583DTO1281.toString());
    }
}
