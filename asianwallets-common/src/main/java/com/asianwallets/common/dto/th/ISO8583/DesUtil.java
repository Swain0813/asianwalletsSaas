...
public class DesUtil {
	...
	public static String desEncrypt(String key,String data) throws DesCryptionException{
		return ISOUtil.bytesToHexString(desEncrypt(ISOUtil.hexStringToByte(key), ISOUtil.hexStringToByte(data)));
	}
	...
	public static String desDecrypt(String key,String data) throws DesCryptionException{
		return ISOUtil.bytesToHexString(desDecrypt(ISOUtil.hexStringToByte(key), ISOUtil.hexStringToByte(data)));
	}
	...
	public static String doubleDesEncrypt(String key,String data) throws DesCryptionException{
		return ISOUtil.bytesToHexString(doubleDesEncrypt(ISOUtil.hexStringToByte(key), ISOUtil.hexStringToByte(data)));
	}
	...
	public static String doubleDesDecrypt(String key,String data) throws DesCryptionException{
		return ISOUtil.bytesToHexString(doubleDesDecrypt(ISOUtil.hexStringToByte(key), ISOUtil.hexStringToByte(data)));
	}
}