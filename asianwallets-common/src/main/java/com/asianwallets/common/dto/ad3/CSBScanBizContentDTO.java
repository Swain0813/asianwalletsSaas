...
@Data
@ApiModel(value = "AD3线下CSB支付接口业务参数实体", description = "AD3线下CSB支付接口业务参数实体")
public class CSBScanBizContentDTO {
    ...
    @ApiModelProperty(value = "支付方式")//20微信扫码 22支付宝扫码 64境外业务
    ...
    public CSBScanBizContentDTO(Orders orders, Channel channel) {
        ...
        this.body = StringUtils.isEmpty(orders.getProductDescription()) ? "商品" : orders.getProductDescription();//商品描述
