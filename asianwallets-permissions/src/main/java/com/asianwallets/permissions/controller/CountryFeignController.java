...
public class CountryFeignController extends BaseController {
    ...
    public BaseResponse addCountry(@RequestBody @ApiParam CountryDTO country) {
        operationLogService.addOperationLog(this.setOperationLog(this.getUserName(), AsianWalletConstant.ADD, JSON.toJSONString(country),
                "新增国家"));
    ...
    public BaseResponse updateCountry(@RequestBody @ApiParam CountryDTO country) {
        operationLogService.addOperationLog(this.setOperationLog(this.getUserName(), AsianWalletConstant.UPDATE, JSON.toJSONString(country),
                "修改国家"));
    ...
    public BaseResponse pageCountry(@RequestBody @ApiParam CountryDTO country) {
        operationLogService.addOperationLog(this.setOperationLog(this.getUserName(), AsianWalletConstant.SELECT, JSON.toJSONString(country),
                "查询国家"));
