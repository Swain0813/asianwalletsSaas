...
public class ExchangeRateFeignController extends BaseController {
    ...
    public BaseResponse addExchangeRate(@RequestBody @ApiParam ExchangeRateDTO exchangeRateDTO) {
        //添加操作日志
        operationLogService.addOperationLog(this.setOperationLog(this.getUserName(), AsianWalletConstant.ADD, JSON.toJSONString(exchangeRateDTO),
                "添加汇率信息"));
    ...
    public BaseResponse banExchangeRate(@RequestParam @ApiParam String id){
        //添加操作日志
        operationLogService.addOperationLog(this.setOperationLog(this.getUserName(), AsianWalletConstant.UPDATE, JSON.toJSONString(id),
                "禁用汇率信息"));
    ...
    public BaseResponse getByMultipleConditions(@RequestBody @ApiParam ExchangeRateDTO exchangeRateDTO) {
        //添加操作日志
        operationLogService.addOperationLog(this.setOperationLog(this.getUserName(), AsianWalletConstant.SELECT, JSON.toJSONString(exchangeRateDTO),
                "分页查询汇率信息"));
