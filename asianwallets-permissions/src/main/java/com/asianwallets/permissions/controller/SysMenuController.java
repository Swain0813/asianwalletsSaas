...
public class SysMenuController extends BaseController {
    ...
    public BaseResponse addThreeLayerMenu(@RequestBody @ApiParam FirstMenuDto firstMenuDto) {
        operationLogService.addOperationLog(setOperationLog(this.getSysUserVO().getUsername(), AsianWalletConstant.ADD, JSON.toJSONString(firstMenuDto),
                "添加一二三级菜单权限信息"));
        return ResultUtil.success(sysMenuService.addThreeLayerMenu(this.getSysUserVO().getUsername(), firstMenuDto));
    }
    ...
    public BaseResponse addTwoLayerMenu(@RequestBody @ApiParam SecondMenuDto secondMenuDto) {
        operationLogService.addOperationLog(setOperationLog(this.getSysUserVO().getUsername(), AsianWalletConstant.ADD, JSON.toJSONString(secondMenuDto),
                "添加二三级菜单权限信息"));
        return ResultUtil.success(sysMenuService.addTwoLayerMenu(this.getSysUserVO().getUsername(), secondMenuDto));
    }
    ...
    public BaseResponse addOneLayerMenu(@RequestBody @ApiParam ThreeMenuDto threeMenuDto) {
        operationLogService.addOperationLog(setOperationLog(this.getSysUserVO().getUsername(), AsianWalletConstant.ADD, JSON.toJSONString(threeMenuDto),
                "添加三级菜单权限信息"));
        return ResultUtil.success(sysMenuService.addOneLayerMenu(this.getSysUserVO().getUsername(), threeMenuDto));
    }

    @ApiOperation(value = "添加菜单权限信息")
    @PostMapping("/addMenu")
    public BaseResponse addMenu(@RequestBody @ApiParam SysMenuDto sysMenuDto) {
        operationLogService.addOperationLog(setOperationLog(this.getSysUserVO().getUsername(), AsianWalletConstant.ADD, JSON.toJSONString(sysMenuDto),
                "添加菜单权限信息"));
        return ResultUtil.success(sysMenuService.addMenu(this.getSysUserVO().getUsername(), sysMenuDto));
    }

    @ApiOperation(value = "删除权限信息")
    @GetMapping("/deleteMenu")
    public BaseResponse deleteMenu(@RequestParam @ApiParam String menuId) {
        operationLogService.addOperationLog(setOperationLog(this.getSysUserVO().getUsername(), AsianWalletConstant.DELETE, JSON.toJSONString(menuId),
                "删除权限信息"));
    ...
    public BaseResponse updateMenu(@RequestBody @ApiParam SysMenuDto sysMenuDto) {
        operationLogService.addOperationLog(setOperationLog(this.getSysUserVO().getUsername(), AsianWalletConstant.UPDATE, JSON.toJSONString(sysMenuDto),
                "修改权限信息"));
        return ResultUtil.success(sysMenuService.updateMenu(this.getSysUserVO().getUsername(), sysMenuDto));
    }
    ...
    public BaseResponse getAllMenuByUserId(@RequestParam(value = "userId", required = false) @ApiParam String userId,
        ...
        operationLogService.addOperationLog(setOperationLog(this.getSysUserVO().getUsername(), AsianWalletConstant.SELECT, JSONObject.toJSONString(getRequest().getParameterMap()),
                "查询用户所有权限信息"));
    ...
    public BaseResponse updateInsPermission(@RequestBody @ApiParam UpdateInsPermissionDto updateInsPermissionDto) {
        return ResultUtil.success(sysMenuService.updateInsPermission(this.getSysUserVO().getUsername(), updateInsPermissionDto));
    }
