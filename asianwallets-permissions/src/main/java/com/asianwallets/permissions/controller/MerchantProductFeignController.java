...
public class MerchantProductFeignController extends BaseController {
    ...
    public BaseResponse addMerchantProduct(@RequestBody @ApiParam List<MerchantProductDTO> merchantProductDTOs) {
        operationLogService.addOperationLog(this.setOperationLog(this.getUserName(), AsianWalletConstant.ADD, JSON.toJSONString(merchantProductDTOs),
                "添加商户产品"));
    ...
    public BaseResponse updateMerchantProduct(@RequestBody @ApiParam MerchantProductDTO merchantProductDTO) {
        operationLogService.addOperationLog(this.setOperationLog(this.getUserName(), AsianWalletConstant.UPDATE, JSON.toJSONString(merchantProductDTO),
                "修改商户产品"));
    ...
    public BaseResponse auditMerchantProduct(@RequestBody @ApiParam AuaditProductDTO auaditProductDTO) {
        operationLogService.addOperationLog(this.setOperationLog(this.getUserName(), AsianWalletConstant.UPDATE, JSON.toJSONString(auaditProductDTO),
                "批量审核商户产品"));
    ...
    public BaseResponse allotMerProductChannel(@RequestBody @ApiParam @Valid MerProDTO merProDTO) {
        operationLogService.addOperationLog(this.setOperationLog(this.getUserName(), AsianWalletConstant.UPDATE, JSON.toJSONString(merProDTO),
                "商户分配通道"));
    ...
    public BaseResponse pageFindMerProduct(@RequestBody @ApiParam MerchantProductDTO merchantProductDTO) {
        operationLogService.addOperationLog(this.setOperationLog(this.getUserName(), AsianWalletConstant.SELECT, JSON.toJSONString(merchantProductDTO),
                "分页查询商户产品信息"));
    ...
    public BaseResponse getMerProductById(@RequestParam @ApiParam String merProductId) {
        operationLogService.addOperationLog(this.setOperationLog(this.getUserName(), AsianWalletConstant.SELECT, JSON.toJSONString(merProductId),
                "根据产品Id查询商户产品详情"));
    ...
    public BaseResponse pageFindMerProChannel(@RequestBody @ApiParam SearchChannelDTO searchChannelDTO) {
        operationLogService.addOperationLog(this.setOperationLog(this.getUserName(), AsianWalletConstant.SELECT, JSON.toJSONString(searchChannelDTO),
                "分页查询商户产品通道管理信息"));
    ...
    public BaseResponse getMerChannelInfoById(@RequestParam @ApiParam String merChannelId) {
        operationLogService.addOperationLog(this.setOperationLog(this.getUserName(), AsianWalletConstant.SELECT, JSON.toJSONString(merChannelId),
                "根据商户通道Id查询商户通道详情"));
    ...
    public BaseResponse updateMerchantChannel(@RequestBody @ApiParam List<BatchUpdateSortDTO> batchUpdateSort) {
        operationLogService.addOperationLog(this.setOperationLog(this.getUserName(), AsianWalletConstant.UPDATE, JSON.toJSONString(batchUpdateSort),
                "修改机构通道"));
    ...
    public BaseResponse getRelevantInfo(@RequestParam @ApiParam String merchantId) {
        operationLogService.addOperationLog(this.setOperationLog(this.getUserName(), AsianWalletConstant.SELECT, JSON.toJSONString(merchantId),
                "查询商户分配通道关联关系"));
