...
public class ChannelFeignController extends BaseController {
    ...
    public BaseResponse addChannel(@RequestBody @ApiParam ChannelDTO channelDTO) {
        operationLogService.addOperationLog(setOperationLog(this.getUserName().getUsername(), AsianWalletConstant.ADD, JSON.toJSONString(channelDTO),
                "添加通道信息"));
    ...
    public BaseResponse updateChannel(@RequestBody @ApiParam ChannelDTO channelDTO) {
        operationLogService.addOperationLog(setOperationLog(this.getUserName().getUsername(), AsianWalletConstant.UPDATE, JSON.toJSONString(channelDTO),
                "修改通道信息"));
    ...
    public BaseResponse pageFindChannel(@RequestBody @ApiParam ChannelDTO channelDTO) {
        operationLogService.addOperationLog(setOperationLog(this.getUserName().getUsername(), AsianWalletConstant.SELECT, JSON.toJSONString(channelDTO),
                "分页查询通道信息"));
    ...
    public BaseResponse getChannelById(@RequestParam @ApiParam String channelId) {
        operationLogService.addOperationLog(setOperationLog(this.getUserName().getUsername(), AsianWalletConstant.SELECT, JSON.toJSONString(channelId),
                "根据通道ID查询通道详情"));
