...
public class ProductFeignController extends BaseController {
    ...
    public BaseResponse addProduct(@RequestBody @ApiParam ProductDTO productDTO) {
        operationLogService.addOperationLog(this.setOperationLog(this.getUserName(), AsianWalletConstant.ADD, JSON.toJSONString(productDTO),
                "添加产品"));
    ...
    public BaseResponse updateProduct(@RequestBody @ApiParam ProductDTO productDTO) {
        operationLogService.addOperationLog(this.setOperationLog(this.getUserName(), AsianWalletConstant.UPDATE, JSON.toJSONString(productDTO),
                "更新产品"));
    ...
    public BaseResponse pageProduct(@RequestBody @ApiParam ProductDTO productDTO) {
        operationLogService.addOperationLog(this.setOperationLog(this.getUserName(), AsianWalletConstant.SELECT, JSON.toJSONString(productDTO),
                "分页查询产品"));
