...
public class DeviceInfoFeignController extends BaseController {
    ...
    public BaseResponse addDeviceInfo(@RequestBody @ApiParam DeviceInfoDTO deviceInfoDTO) {
        operationLogService.addOperationLog(this.setOperationLog(this.getUserName(), AsianWalletConstant.ADD, JSON.toJSONString(deviceInfoDTO),
                "新增设备信息"));
    ...
    public BaseResponse banDeviceInfo(@RequestBody @ApiParam DeviceInfoDTO deviceInfoDTO) {
        operationLogService.addOperationLog(this.setOperationLog(this.getUserName(), AsianWalletConstant.UPDATE, JSON.toJSONString(deviceInfoDTO),
                "启用禁用设备信息"));
    ...
    public BaseResponse pageDeviceInfo(@RequestBody @ApiParam DeviceInfoDTO deviceInfoDTO) {
        operationLogService.addOperationLog(this.setOperationLog(this.getUserName(), AsianWalletConstant.SELECT, JSON.toJSONString(deviceInfoDTO),
                "查询设备信息"));
    ...
    public BaseResponse uploadDeviceInfo(@RequestParam("file") @ApiParam MultipartFile file) {
        ...
        return deviceInfoFeign.uploadDeviceInfo(deviceInfoFeignService.uploadDeviceInfo(file, this.getUserName()));
    }
