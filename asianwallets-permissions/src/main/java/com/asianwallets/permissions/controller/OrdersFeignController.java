...
public class OrdersFeignController extends BaseController {
    ...
    public BaseResponse getOrdersDetail(@RequestParam("id") @ApiParam String id) {
        operationLogService.addOperationLog(setOperationLog(this.getUserName(), AsianWalletConstant.SELECT, JSON.toJSONString(id),
                "查询订单详情信息"));
    ...
    public BaseResponse pageFindOrdersRefund(@RequestBody @ApiParam OrdersRefundDTO ordersRefundDTO) {
        operationLogService.addOperationLog(setOperationLog(this.getUserName(), AsianWalletConstant.SELECT, JSON.toJSONString(ordersRefundDTO),
                "分页查询退款订单信息"));
    ...
    public BaseResponse getOrdersRefundDetail(@RequestParam("refundId") @ApiParam String refundId) {
        operationLogService.addOperationLog(setOperationLog(this.getUserName(), AsianWalletConstant.SELECT, JSON.toJSONString(refundId),
                "查询退款订单详情信息"));
    ...
    public BaseResponse exportOrdersRefund(@RequestBody @ApiParam OrdersRefundDTO ordersRefundDTO, HttpServletResponse response) {
        operationLogService.addOperationLog(setOperationLog(this.getUserName(),
    ...
    public BaseResponse updateOrderStatus(@RequestBody @ApiParam ArtificialDTO artificialDTO) {
        operationLogService.addOperationLog(setOperationLog(this.getUserName(), AsianWalletConstant.UPDATE, JSONObject.toJSONString(artificialDTO),
                "运营后台修改订单状态"));
