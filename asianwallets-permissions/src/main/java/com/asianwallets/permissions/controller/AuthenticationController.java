...
public class AuthenticationController {
    ...
    public BaseResponse operationLogin(@RequestBody @ApiParam AuthenticationRequest request) {
    ...
    public BaseResponse institutionLogin(@RequestBody @ApiParam AuthenticationRequest request) {
    ...
    public BaseResponse merchantLogin(@RequestBody @ApiParam AuthenticationRequest request) {
        return ResultUtil.success(authenticationService.merchantLogin(request));
    }

    @ApiOperation(value = "代理商系统登录")
    @PostMapping("/agentLogin")
    public BaseResponse agentLogin(@RequestBody @ApiParam AuthenticationRequest request) {
    ...
    public BaseResponse terminalLogin(@RequestBody @ApiParam AuthenticationRequest request) {
        return ResultUtil.success(authenticationService.terminalLogin(request));
    }
}
