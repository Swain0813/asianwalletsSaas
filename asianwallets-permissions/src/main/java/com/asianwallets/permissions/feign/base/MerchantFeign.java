...
public interface MerchantFeign {
    ...
    BaseResponse getAllAgent(@RequestParam("merchantType") @ApiParam String merchantType,@RequestParam("agentType") @ApiParam String agentType,@RequestParam("institutionCode") @ApiParam String institutionCode);
